...
=======
python3.11 -m pip install --upgrade --no-cache-dir git+https://github.com/openrecall/openrecall.git
>>>>>>> 4b1cd743543ee53775755f18695fc933e7707714
```

To run:
```
python3.11 -m openrecall.app
```
